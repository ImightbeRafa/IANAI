...
const MODEL_COSTS = {
  ...
  // App id `grok-imagine` → provider grok-imagine-image-2.0.
  // Prefer costOverrideUsd from estimateGrokImageCostUsd ($0.04/out + $0.01/input ref).
  // Fallback perImage alone undercounts edits when override is missing.
