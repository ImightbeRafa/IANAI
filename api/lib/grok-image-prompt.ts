...
export const GROK_IMAGE_RETRY_PROMPT_BYTES = 5_500
/** @deprecated Alias for retry — callers that still pass maxLength. */
export const GROK_IMAGE_RETRY_PROMPT_LENGTH = GROK_IMAGE_RETRY_PROMPT_BYTES
