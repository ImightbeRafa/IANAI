      ...
      <>
        ...
        <div className="relative" ref={hookPickerVersion === versionIndex ? hookPickerRef : undefined}>
          ...
          {hookPickerVersion === versionIndex && (
            <div className="absolute right-0 bottom-full mb-1 w-64 bg-dark-100 border border-dark-200 rounded-lg shadow-xl z-50 max-h-72 overflow-y-auto">
