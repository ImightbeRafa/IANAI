...
const MODEL_INFO: Record<string, { name: string; color: string }> = {
  ...
  'fal-ai/kling-video/v2.6/pro/text-to-video': { name: 'Kling 2.6 Text', color: 'bg-cyan-500' },
  'fal-ai/kling-video/v2.6/pro/image-to-video': { name: 'Kling 2.6 Image', color: 'bg-cyan-600' },
