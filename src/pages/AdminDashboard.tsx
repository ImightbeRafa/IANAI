...
const MODEL_INFO: Record<string, { name: string; color: string }> = {
  ...
  'grok-3': { name: 'Grok 3', color: 'bg-purple-500' },
  'grok-3-fast': { name: 'Grok 3 Fast', color: 'bg-purple-400' },
  'grok-3-mini': { name: 'Grok 3 Mini', color: 'bg-fuchsia-500' },
  'grok-3-mini-fast': { name: 'Grok 3 Mini Fast', color: 'bg-fuchsia-400' },
  ...
  'grok-4-1-fast-reasoning': { name: 'Grok 4.1 Fast', color: 'bg-cyan-500' },
  'grok-4-fast-non-reasoning': { name: 'Grok 4 Fast', color: 'bg-cyan-400' },
  'whisper-1': { name: 'Whisper (OpenAI)', color: 'bg-green-500' },
  'whisper-large-v3': { name: 'Whisper Large', color: 'bg-green-400' },
  'gemini': { name: 'Gemini Flash (legacy id)', color: 'bg-blue-500' },
  ...
  'grok-imagine-image-2.0': { name: 'Grok Imagine 2.0', color: 'bg-pink-500' },
  'grok-imagine-video': { name: 'Grok Imagine Video', color: 'bg-rose-500' },
  'grok-imagine-video-720p': { name: 'Grok Imagine Video 720p', color: 'bg-rose-400' },
  'grok-imagine-video-480p': { name: 'Grok Imagine Video 480p', color: 'bg-rose-300' },
...
const MODEL_PRICING: Record<string, string> = {
  ...
  'grok-imagine-video-720p': '$0.05/sec',
