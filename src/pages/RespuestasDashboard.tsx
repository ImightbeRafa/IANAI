...
export default function RespuestasDashboard() {
  ...
  const labels = {
    es: {
      title: 'Respuestas',
      subtitle: 'Genera respuestas óptimas para tus conversaciones con clientes',
      noProducts: 'No hay productos aún',
      createFirst: 'Crea tu primer producto en el Dashboard para empezar a generar respuestas',
      ...
      generateReplies: 'Generar Respuestas',
    ...
    en: {
      title: 'Replies',
      subtitle: 'Generate optimal responses for your client conversations',
      noProducts: 'No products yet',
      createFirst: 'Create your first product in the Dashboard to start generating replies',
      ...
      generateReplies: 'Generate Replies',
  ...
  const renderProductCard = (product: Product, sharedInfo?: { role: string; email: string }) => {
    ...
    return (
      <Link
        key={product.id}
        to={`/respuestas/product/${product.id}`}
